...
<body>
    <div class="container">
        <div class="content">
            ...
            <p>My name is <span class="highlighted-name">John Doe</span>, I am an <span class="trainer">AWS and DevOps Trainer</span>.</p>
            ...
            <p>
                ...
                <a href="https://www.linkedin.com/in/kastro-kiran/" target="_blank">
                    <button class="linkedin-button"><i class="fab fa-linkedin"></i>LinkedIn</button>
                </a>
            </p>
        </div>
    </div>
